...
class Establish extends Component {
    ...
    handleSearch = (e) => {
        ...
        const value=this.props.isUpdate;
        form.validateFields(['wwpId','weekNo','airplaneRegNo','workInfo','commandNo','executeTime','airplaneStandDays','standCode','company','totalWorkingHours','packageState'],(error,values) => {
                ...
                >
                    ...
                    >
                            {getFieldDecorator('commandNo', {
                                ...
                                <Input onBlur={_=>this.Verification()} disabled={isUpdate?true:false}/>
                            )}
                    </FormItem>
