        ...
        return (
            <div>
                                ...
                                <Col span={8} key={5} >
                                    ...
                                    >
                                        {getFieldDecorator('allotType', {
                                            ...
                                            <Cascader options={allotType}  showSearch placeholder=""/>
                                        )}
                                    </FormItem>
                                </Col>
                                <Col span={8} key={1} >
                ...
                <div className="content" >
                    ...
                    <Table  columns={columns} dataSource={data} pagination={false} rowKey='id' loading={this.state.loading} rowSelection={rowSelection}/>
